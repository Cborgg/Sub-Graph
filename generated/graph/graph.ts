...
export class graph__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class graph extends ethereum.SmartContract {
  static bind(address: Address): graph {
    return new graph("graph", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): graph__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new graph__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<graph__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new graph__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
